...
FACULTIE_URL = "https://vsu.by/studentam/raspisanie-zanyatij.html"
        ...
        for link in soup.find_all("a"):
            ...
            if (
                ...
                and (
                    ...
                    or (
                        f"{monday[0]}.{monday[1][1]}" in link.text
                        and monday[1][0] == "0"
                    )
                    or (
                        f"{monday[0][1]}.{monday[1][1]}" in link.text
                        and monday[0][0] == "0"
                        and monday[1][0] == "0"
                    )
                    or (
                        f"{monday[0][1]}.{monday[1]}" in link.text
                        and monday[0][0] == "0"
                    )
                )
